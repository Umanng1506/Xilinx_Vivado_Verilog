...
HD_PWD='E:/College/Verilog_practice/gates_bdf/gates_bdf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gates_bdf_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gates_bdf_wrapper.tcl
