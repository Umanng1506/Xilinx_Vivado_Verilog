...
HD_PWD='E:/College/Verilog_practice/decoder_2to4/decoder_2to4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_4to2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_4to2.tcl
