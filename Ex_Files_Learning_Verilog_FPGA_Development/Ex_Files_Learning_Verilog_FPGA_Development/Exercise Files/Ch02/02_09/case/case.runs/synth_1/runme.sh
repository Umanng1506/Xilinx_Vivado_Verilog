...
HD_PWD='C:/Verilog/02_09/case/case.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1_to_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_1_to_4.tcl
