...
HD_PWD='E:/College/Verilog_practice/mux_2to1/mux_2to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_2to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_2to1.tcl -notrace
