...
HD_PWD='E:/College/Verilog_practice/encoder_4to2/encoder_4to2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_4to2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_4to2.tcl -notrace
