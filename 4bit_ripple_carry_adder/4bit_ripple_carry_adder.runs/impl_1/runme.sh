...
HD_PWD='E:/College/Verilog_practice/4bit_ripple_carry_adder/4bit_ripple_carry_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ripple_carry_adder_4bit.tcl -notrace
