...
HD_PWD='E:/College/Verilog_practice/4bit_ripple_carry_adder/4bit_ripple_carry_adder.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ripple_carry_adder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_carry_adder_4bit.tcl
